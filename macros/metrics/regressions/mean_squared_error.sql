{% macro mean_squared_error(actuals_table_name, actuals_variable_name, actuals_value, predictions_table_name, predictions_variable_name, predictions_run_id, predictions_value) -%}
